...
function initModels(sequelize) {
  ...
  concrete_product.belongsTo(product, { as: "product", foreignKey: "id"});
  product.hasOne(concrete_product, { as: "concreteProduct", foreignKey: "id"});
  product_group.belongsTo(product, { as: "product", foreignKey: "id"});
  product.hasOne(product_group, { as: "productGroup", foreignKey: "id"});
  product.belongsToMany(product_group, { as: "group", through: "products_relations", foreignKey: "product_id", otherKey: "category_id"});
  ...
  product_group.belongsToMany(product, { as: "concreteProduct", through: "products_relations", foreignKey: "category_id", otherKey: "product_id"});
